...
export const defaultStore = markRaw(new Storage('base', {
	...
	postFormFooterEmojiIconEnabled: { // これも自由に並べ替えれる実装にするべきかも
		where: 'device',
		default: false,
	},
	...
	userDetail_hideFollowers_remote: {
		where: 'device',
		default: false,
	},
	userDetail_hideFollowing: {
		where: 'device',
		default: false,
	},
	userDetail_hideFollowing_remote: {
		where: 'device',
		default: false,
	},
	userDetail_hideNoteCount: {
		where: 'device',
		default: false,
	},
	userDetail_hideNoteCount_remote: {
		where: 'device',
		default: false,
	},
	userDetail_hideShowOnRemote: {
		where: 'device',
		default: false,
	},
}));
